...
data_handling_task = DataHandlingOperator(param='param1', task_id='data_handling_task', dag=dag)

data_classification_task = DataClassificationOperator(param='param2', task_id='data_classification_task', dag=dag)
